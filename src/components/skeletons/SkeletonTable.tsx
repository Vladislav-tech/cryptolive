...
export const SkeletonTable = ({ count = 6 }: SkeletonTableProps) => {
  return (
              ...
              <tr key={i} className="border-b border-slate-700/50">
                ...
                <td className="px-3 sticky left-12 z-30 bg-slate-900 min-w-35 shadow-[4px_0_8px_-2px_rgba(0,0,0,0.3)]">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-slate-700 rounded-lg animate-pulse shrink-0" />
                ...
                <td className="px-3 min-w-50">
                  <div className="w-full h-20 bg-slate-700 rounded animate-pulse" />
                </td>
              </tr>
            ))}
          </tbody>
