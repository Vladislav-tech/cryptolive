...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 mb-8 backdrop-blur-lg bg-gradient-to-r">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">

          <div className="flex items-center gap-4">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 rounded-2xl blur-lg opacity-70 animate-pulse"></div>
              <div className="relative bg-gradient-to-br from-blue-600 to-indigo-600 p-3 rounded-2xl shadow-xl ring-2 ring-white/20 hover:scale-105 transition-transform duration-300">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            >
              ...
              <span className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 group-hover:w-4/5 transition-all duration-300"></span>
            </Link>
